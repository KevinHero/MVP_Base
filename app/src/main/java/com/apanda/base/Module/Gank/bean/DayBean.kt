...
class DayBean : Serializable {
    ...
    var results: ResultsEntity? = null
    var category: List<String>? = null

    class ResultsEntity : Serializable {
        var Android: List<ItemBean>? = null
        var iOS: List<ItemBean>? = null
        var 休息视频: List<ItemBean>? = null
        var 拓展资源: List<ItemBean>? = null
        var 福利: List<ItemBean>? = null
        var 瞎推荐: List<ItemBean>? = null
        var App: List<ItemBean>? = null
        var 前端: List<ItemBean>? = null
    }
