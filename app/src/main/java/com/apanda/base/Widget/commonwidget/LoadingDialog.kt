...
object LoadingDialog {
     ...
     */
    fun showDialogForLoading(context: Activity, msg: String, cancelable: Boolean): Dialog {
        val view = LayoutInflater.from(context).inflate(R.layout.dialog_loading, null)
        val loadingText = view.findViewById(R.id.id_tv_loading_dialog_text) as TextView
