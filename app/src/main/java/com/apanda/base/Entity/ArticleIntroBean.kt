...
class ArticleIntroBean {
    ...
    var recommended_article: List<RecommendedArticleBean>? = null


    class RecommendedArticleBean {
        ...
        var article_shares: Int = 0
        var article_collects: Int = 0
        var article_brief_intro: String? = null
    }
