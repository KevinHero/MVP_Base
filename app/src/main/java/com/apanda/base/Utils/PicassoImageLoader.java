...
public class PicassoImageLoader implements ImageLoader, NineGridView.ImageLoader {
    ...
    public void displayImage(Activity activity, ImageView imageView, String path) {
    ...
    public void displayImage(Activity activity, ImageView imageView, ImageItem _imageItem) {
        Picasso.with(activity)                           //配置上下文
